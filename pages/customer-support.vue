...
const featuresData = [
  {
    position: "right",
    img: one,
    title: "Get the customer support you deserve with EATTE",
    sub_title: `Our team of experts is here 24/7 to provide you with the best customer service experience. From live chat, email and phone support, to personalized tips and tricks tailored to your individual needs, EATTE provides the help you need when you need it. Get the answers you need and feel supported with EATTE's top-notch customer care team`,
  },
];
</script>
...
<template>
  <div class="screen_container">
    <IoHeadersRow
      ...
      :sub_text="`Get outstanding customer support with EATTE! Our customer service team is available 24/7 to answer any questions you may have and resolve any issues. With our personalized approach and comprehensive troubleshooting solutions, you can rest assured that your experience will be smooth and hassle-free. Get the help you deserve with EATTE!`"
